...
sudo dnf install -y gcc-toolset-15 # check of latest gcc toolset version on https://pkgs.org/search/?q=gcc-toolset
sudo dnf install -y clang clang-tools-extra llvm pinentry pinentry-tty llvm-toolset llvm-devel
